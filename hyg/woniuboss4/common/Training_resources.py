...
from woniuboss4.unit.utility import *
...
class Training_Resources:
    ...
    #点击资源管理内的培训资源
        ...
        # #点击解密按钮
        driver.find_element_by_css_selector('#btn-decrypt').click()
        driver.find_element_by_css_selector('div.modal-body:nth-child(2) > input:nth-child(1)').send_keys('WOniu123')
        driver.find_element_by_css_selector('#secondPass-modal > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > button:nth-child(1)').click()
    #选择资源库的下拉框
    def resource_store(self,driver,value): # 资源库下拉框
        Resource_bank= driver.find_element_by_css_selector('div.col-lg-12:nth-child(1) > select:nth-child(1)')
        selects = Select(Resource_bank)
        selects.select_by_visible_text(value)
    #选择状态的下拉框
    def select_status(self,driver,value):
        state = driver.find_element_by_css_selector('div.col-lg-12:nth-child(1) > select:nth-child(2)')
        select = Select(state)
        select.select_by_visible_text(value)

    def select_source(self,driver,value):
        # #选择来源下拉框
        source = driver.find_element_by_css_selector('div.col-lg-12:nth-child(1) > select:nth-child(3)')
