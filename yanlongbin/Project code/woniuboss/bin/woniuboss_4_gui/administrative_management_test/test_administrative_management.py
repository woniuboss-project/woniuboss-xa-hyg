...
from woniuboss.lib.woniuboss_4_gui.administrative_management.administrative_management import AdministrativeManagement
...
# 准备数据
test_config_info=Utility.get_json('..\\..\\conf\\woniuboss_4_gui\\AM\\testdata.conf')
...
class AdministrativeManagementTest(unittest.TestCase):
    ...
    def test_am_management(cls, data,expect):
        ...
        if Service.is_element_present(cls.driver, By.LINK_TEXT, '采购登记'):
            actual = 'AM_correct'
        else:
            actual = 'AM_failed'
            cls.driver.refresh()
    ...
    def test_am_recipients(cls, data,expect):
        ...
        if Service.is_element_present(cls.driver, By.LINK_TEXT, '领用登记'):
            actual = 'AM_correct'
        else:
            actual = 'AM_failed'
            cls.driver.refresh()
