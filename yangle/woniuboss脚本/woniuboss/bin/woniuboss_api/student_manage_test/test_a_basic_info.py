...
class BasicInfoTest(unittest.TestCase):
    ...
    def test_a_query_all(self,url,post,data,status_code,expect):
    ...
    def test_b_view_one_student(self, url, post, data, status_code, expect):
    ...
    def test_c_modify_student_info(self,url, post, data, status_code, expect):
        ...
        if modify_student_resp.text=='success':
            actual='test modify student pass'
        else:
            actual='test modify student fail'
